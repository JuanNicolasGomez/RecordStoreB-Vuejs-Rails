<template>
    <div class="max-w-sm m-auto my-8">
        <div class="border p-10 border-grey-light shadow rounded">
            <h3 class= "text-2x1 mb-6 text-grey-darkest">Sign Up</h3>
            <form @submit.prevent="signup">
                ...
                bg-green hover:bg-green-dark block w-full py-4 text-white items-center justify-center">
                Sign Up</button>
...
export default {
    ...
    methods: {
        ...
        signupFailed(error){
            ...
            this.error = ( error.response && error.data && error.response.data.error) || 'Something went wrong'
